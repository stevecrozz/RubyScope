(function(exports, $){
  ...
  var DebuggerUi = function(options){
    ...
    if (typeof options.panes !== "undefined") {
      var i;
      for (i=0; i<options.panes.length; i++) {

        var pane = options.panes[i];
        if (typeof pane.views === "undefined") {
          break;
        }

        var j;
        for (j=0; j<pane.views.length; j++) {
          this.views.push(
            new pane.views[j](this, pane.el)
          );
        }
      }
    }
