...
(function($, DebuggerUi){
  ...
  $(function(){
    ...
    $("form.connect").on("submit", function(){
      ...
      new DebuggerUi.View.StackView(ui, detailsPane);
      new DebuggerUi.View.BreakpointView(ui, detailsPane);
      new DebuggerUi.View.ThreadView(ui, detailsPane);
      new DebuggerUi.View.FileView(ui, detailsPane);
      new DebuggerUi.View.ConsoleView(ui, consolePane);
      new DebuggerUi.View.CodeView(ui, contentPane);
      new DebuggerUi.View.ControlView(ui, controlPane, [
