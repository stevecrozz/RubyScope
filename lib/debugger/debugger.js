(function($){
  ...
  /**
   * Callback received when listing files. Fill the content pane with code.
   */
  DebuggerUi.prototype.list = function(content){
    // populate the list
  ...
  $(function(){
    ...
    $(".files ul").on("click", "li", function(event){
      ui.debuggerClient.readFile($(this).text(), ui.list);
