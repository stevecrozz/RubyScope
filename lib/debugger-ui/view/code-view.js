...
(function($, DebuggerUi){
  ...
  DebuggerUi.View.CodeView = function(ui, parent){
    var view = this;
   ...
   */
  DebuggerUi.View.CodeView.prototype.breakpointMarker = "<span style=\"color: #900\">●</span>";


  DebuggerUi.View.CodeView.prototype.render = function(content, breakpoints, currentFile, currentLine, openFile){
    var codeView = this;
    var ui = this.ui;
