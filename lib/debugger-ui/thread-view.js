(function($, DebuggerUi){
  ...
  DebuggerUi.ThreadView = function(ui, parent){
    this.ui = ui;
  ...
  DebuggerUi.ThreadView.prototype.selectThread = function(e){
    this.ui.debuggerClient.switchThread($(e.target).data("thread_id"));
    this.ui.refresh();
  };

  DebuggerUi.ThreadView.prototype.render = function(threads){
    var lis = $();
